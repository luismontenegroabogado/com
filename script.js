document.addEventListener('DOMContentLoaded', function () {
    // Función para cargar las entradas del blog desde un archivo JSON
    function loadBlogPosts() {
        // Eliminado: Esta función ya no se necesita
    }
    ...
    // Llamar a la función para cargar las entradas del blog
    // Eliminado: Esta función ya no se llama, ya que la sección del blog fue eliminada
